...
{
    /**
     * @var \ImgMan\Core\Adapter\ImagickAdapter
     */
    protected $adapter;
    ...
    {
        $this->assertInstanceOf('ImgMan\Core\Adapter\ImagickAdapter', $this->adapter->setBlob($this->image2));
        $this->assertInstanceOf('ImgMan\Core\Adapter\ImagickAdapter', $this->adapter->setBlob($this->image3));
        $this->assertInstanceOf('ImgMan\Core\Adapter\ImagickAdapter', $this->adapter->setBlob($this->image));
    }
    ...
    public function testImagickAdapterImageCreate()
    {
        ...
        $this->assertInstanceOf('ImgMan\Core\Blob\Blob', $imgPng);
        $this->assertNotEmpty($imgPng->getBlob());

        $imgJpeg = $this->adapter->create(50, 50, 'jpeg');
        $this->assertInstanceOf('ImgMan\Core\Blob\Blob', $imgJpeg);
